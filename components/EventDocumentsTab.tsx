...
export const EventDocumentsTab: React.FC<EventDocumentsTabProps> = ({
  ...
  useEffect(() => {
    if (!shareDoc) setWhatsAppNextIndex(null);
  }, [shareDoc]);
                ...
                <>
                  <div className="flex flex-col gap-3">
                    ...
                    >
                      ...
                      Partager le document (envoi groupé)
                    </button>
                    <p className="text-xs text-slate-500">
                      Un clic ouvre le partage. Choisissez WhatsApp (ou Mail, Messages…) puis sélectionnez plusieurs conversations pour envoyer à tous en une fois.
                    </p>
                  </div>
